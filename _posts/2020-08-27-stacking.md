...
We now need to prepare our data. Each item is assigned a group, to later be used in k-fold cross validation. One hot encoding is then performed on the labels through 'gen_binary_labels'.
