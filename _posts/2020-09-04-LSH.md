...
We set a paramter 
$$\alpha am$$ 
that is the number of 'collisions' or equal hash values that we require to consider an item similar. Eg, <img src="https://latex.codecogs.com/gif.latex?o_1" title="o_1" /> above has 9 collisions with <img src="https://latex.codecogs.com/gif.latex?q" title="q" />. 
